...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/docs/10.0.0/guides/ingress/configuration/config-volumes) for complete example.
