...
url: /docs/10.0.0/welcome/contributing/
aliases:
- /docs/10.0.0/CONTRIBUTING/
info:
  version: 10.0.0
---
...
We have a [Developer Guide](/docs/10.0.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
