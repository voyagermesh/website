...
url: /docs/v2022.06.20/welcome/contributing/
aliases:
- /docs/v2022.06.20/CONTRIBUTING/
info:
  cli: v0.0.9
...
We have a [Developer Guide](/docs/v2022.06.20/setup/developer-guide/overview) that outlines everything you need to know from setting up your
