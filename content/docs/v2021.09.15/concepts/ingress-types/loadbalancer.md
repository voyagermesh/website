...
- First, install Voyager operator in your cluster following the steps [here](/docs/v2021.09.15/setup/install).

- Now, deploy test servers using [this script](/docs/v2021.09.15/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
