...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/v2021.09.15/setup/install).
...
- [Using HTTP-01 challenge](/docs/v2021.09.15/guides/certificate/http/overview)
- [Using DNS-01 challenge](/docs/v2021.09.15/guides/certificate/dns/providers)
