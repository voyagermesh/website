...
To enable http2, you must first setup a [certificate](/docs/v2021.09.15/guides/certificate) (Let's Encrypt), or use an existing one. Then create an ingress object like below:
