...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/docs/v2021.04.24-rc.0/guides/ingress/configuration/config-volumes) for complete example.
