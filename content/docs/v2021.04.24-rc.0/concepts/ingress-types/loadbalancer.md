...
- First, install Voyager operator in your cluster following the steps [here](/docs/v2021.04.24-rc.0/setup/install).

- Now, deploy test servers using [this script](/docs/v2021.04.24-rc.0/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
