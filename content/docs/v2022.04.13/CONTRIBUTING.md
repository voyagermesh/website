...
url: /docs/v2022.04.13/welcome/contributing/
aliases:
- /docs/v2022.04.13/CONTRIBUTING/
info:
  cli: v0.0.8
...
We have a [Developer Guide](/docs/v2022.04.13/setup/developer-guide/overview) that outlines everything you need to know from setting up your
