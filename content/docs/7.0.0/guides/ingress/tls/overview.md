...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/7.0.0/setup/install).
...
- [Using HTTP-01 challenge](/docs/7.0.0/guides/certificate/http)
- [Using DNS-01 challenge](/docs/7.0.0/guides/certificate/providers)
...
If you would like to uninstall Voyager operator, please follow the steps [here](/docs/7.0.0/setup/uninstall).
