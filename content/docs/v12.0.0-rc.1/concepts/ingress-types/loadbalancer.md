...
- First, install Voyager operator in your cluster following the steps [here](/docs/v12.0.0-rc.1/setup/install).

- Now, deploy test servers using [this script](/docs/v12.0.0-rc.1/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
