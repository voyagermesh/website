...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/v12.0.0-rc.1/setup/install).
...
- [Using HTTP-01 challenge](/docs/v12.0.0-rc.1/guides/certificate/http/overview)
- [Using DNS-01 challenge](/docs/v12.0.0-rc.1/guides/certificate/dns/providers)
