...
url: /docs/5.0.0/welcome/contributing/
aliases:
- /docs/5.0.0/CONTRIBUTING/
info:
  version: 5.0.0
---
...
We have a [Developer Guide](/docs/5.0.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
