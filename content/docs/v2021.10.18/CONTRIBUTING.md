...
url: /docs/v2021.10.18/welcome/contributing/
aliases:
- /docs/v2021.10.18/CONTRIBUTING/
info:
  cli: v0.0.3
...
We have a [Developer Guide](/docs/v2021.10.18/setup/developer-guide/overview) that outlines everything you need to know from setting up your
