...
![create-zone](/docs/6.0.0/images/certificate/google-cloud/create-zone.png)

Once the zone is created, you can see the list of name servers in Google cloud console.

![ns-servers](/docs/6.0.0/images/certificate/google-cloud/ns-servers.png)

Now, go to the website of your domain registrar and update the list of name servers.

![domain-registrar](/docs/6.0.0/images/certificate/google-cloud/domain-registrar.png)
...
![create-svc-account](/docs/6.0.0/images/certificate/google-cloud/create-svc-account.png)
...
![gke-permissions](/docs/6.0.0/images/certificate/google-cloud/gke-permissions.png)
...
![acme-challenge](/docs/6.0.0/images/certificate/google-cloud/acme-challenge.png)
...
![a-record](/docs/6.0.0/images/certificate/google-cloud/a-record.png)
