...
Like this [issuer.yaml](/docs/v2022.01.07/examples/cert-manager/issuer.yaml)
...
You can change that value using `duration` and `renewBefore` field in [certificate.yaml](/docs/v2022.01.07/examples/cert-manager/certificate.yaml),
