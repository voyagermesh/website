...
- First, install Voyager operator in your cluster following the steps [here](/docs/v2022.01.01/setup/install).

- Now, deploy test servers using [this script](/docs/v2022.01.01/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
