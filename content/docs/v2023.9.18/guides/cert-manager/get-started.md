...
Like this [issuer.yaml](/docs/v2023.9.18/examples/cert-manager/issuer.yaml)
...
You can change that value using `duration` and `renewBefore` field in [certificate.yaml](/docs/v2023.9.18/examples/cert-manager/certificate.yaml),
