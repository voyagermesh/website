...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/v2023.9.18/setup/install).
...
- [Using HTTP-01 challenge](/docs/v2023.9.18/guides/certificate/http/overview)
- [Using DNS-01 challenge](/docs/v2023.9.18/guides/certificate/dns/providers)
