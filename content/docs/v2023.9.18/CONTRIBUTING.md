...
url: /docs/v2023.9.18/welcome/contributing/
aliases:
- /docs/v2023.9.18/CONTRIBUTING/
info:
  cli: v0.0.14
...
We have a [Developer Guide](/docs/v2023.9.18/setup/developer-guide/overview) that outlines everything you need to know from setting up your
