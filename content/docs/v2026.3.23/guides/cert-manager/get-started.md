...
Like this [issuer.yaml](/docs/v2026.3.23/examples/cert-manager/issuer.yaml)
...
You can change that value using `duration` and `renewBefore` field in [certificate.yaml](/docs/v2026.3.23/examples/cert-manager/certificate.yaml),
