...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/v2026.3.23/setup/install).
...
- [Using HTTP-01 challenge](/docs/v2026.3.23/guides/certificate/http/overview)
- [Using DNS-01 challenge](/docs/v2026.3.23/guides/certificate/dns/providers)
