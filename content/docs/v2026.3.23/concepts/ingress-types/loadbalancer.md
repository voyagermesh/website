...
- First, install Voyager operator in your cluster following the steps [here](/docs/v2026.3.23/setup/install).

- Now, deploy test servers using [this script](/docs/v2026.3.23/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
