...
- First, install Voyager operator in your cluster following the steps [here](/docs/v2024.8.30/setup/install).

- Now, deploy test servers using [this script](/docs/v2024.8.30/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
