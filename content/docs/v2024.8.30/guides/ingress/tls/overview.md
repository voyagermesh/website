...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/v2024.8.30/setup/install).
...
- [Using HTTP-01 challenge](/docs/v2024.8.30/guides/certificate/http/overview)
- [Using DNS-01 challenge](/docs/v2024.8.30/guides/certificate/dns/providers)
