...
Setup a [ClusterIssuer (Or Issuer)](/docs/v2024.8.30/guides/cert-manager/get-started) for your Ingress by applying
this [clusterissuer.yaml](/docs/v2024.8.30/examples/cert-manager/http/clusterissuer.yaml)
...
Now create your ingress by applying [ingress.yaml](/docs/v2024.8.30/examples/cert-manager/http/ingress.yaml)
