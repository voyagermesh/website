...
url: /docs/v2024.8.30/welcome/contributing/
aliases:
- /docs/v2024.8.30/CONTRIBUTING/
info:
  cli: v0.0.16
...
We have a [Developer Guide](/docs/v2024.8.30/setup/developer-guide/overview) that outlines everything you need to know from setting up your
