...
Now, deploy Voyager operator following instructions [here](/docs/v12.0.0/setup/install).
...
![stats-page](/docs/v12.0.0/images/monitoring/stats-view.png)
...
- To monitor your HAProxy pods using builtin [Prometheus](https://prometheus.io/) scraper, visit [here](/docs/v12.0.0/guides/ingress/monitoring/using-builtin-prometheus).
- To monitor your HAProxy pods using [CoreOS Prometheus Operator](/docs/v12.0.0/guides/ingress/monitoring/using-coreos-prometheus-operator), visit [here](/docs/v12.0.0/guides/ingress/monitoring/using-coreos-prometheus-operator).
- To monitor Voyager operator using Prometheus, visit [here](/docs/v12.0.0/guides/ingress/monitoring/operator-stats).
