...
To enable http2, you must first setup a [certificate](/docs/7.0.0-rc.3/guides/certificate) (Let's Encrypt), or use an existing one. Then create an ingress object like below:
