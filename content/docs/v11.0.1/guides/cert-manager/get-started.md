...
Like this [issuer.yaml](/docs/v11.0.1/examples/cert-manager/issuer.yaml)
...
You can change that value using `duration` and `renewBefore` field in [certificate.yaml](/docs/v11.0.1/examples/cert-manager/certificate.yaml),
