...
url: /docs/v11.0.1/welcome/contributing/
aliases:
- /docs/v11.0.1/CONTRIBUTING/
info:
  version: v11.0.1
---
...
We have a [Developer Guide](/docs/v11.0.1/setup/developer-guide/overview) that outlines everything you need to know from setting up your
