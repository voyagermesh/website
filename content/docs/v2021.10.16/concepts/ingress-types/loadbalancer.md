...
- First, install Voyager operator in your cluster following the steps [here](/docs/v2021.10.16/setup/install).

- Now, deploy test servers using [this script](/docs/v2021.10.16/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
