...
![stats-page](/docs/v2022.01.10/images/monitoring/stats-view.png)
...
- To monitor your HAProxy pods using builtin [Prometheus](https://prometheus.io/) scraper, visit [here](/docs/v2022.01.10/guides/ingress/monitoring/using-builtin-prometheus).
- To monitor your HAProxy pods using [CoreOS Prometheus Operator](/docs/v2022.01.10/guides/ingress/monitoring/using-coreos-prometheus-operator), visit [here](/docs/v2022.01.10/guides/ingress/monitoring/using-coreos-prometheus-operator).
- To monitor Voyager operator using Prometheus, visit [here](/docs/v2022.01.10/guides/ingress/monitoring/operator-stats).
