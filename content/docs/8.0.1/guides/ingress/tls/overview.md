...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/8.0.1/setup/install).
...
- [Using HTTP-01 challenge](/docs/8.0.1/guides/certificate/http)
- [Using DNS-01 challenge](/docs/8.0.1/guides/certificate/dns/providers)
...
If you would like to uninstall Voyager operator, please follow the steps [here](/docs/8.0.1/setup/uninstall).
