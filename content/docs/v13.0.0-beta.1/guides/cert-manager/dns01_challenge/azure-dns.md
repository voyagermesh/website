...
![a-record](/docs/v13.0.0-beta.1/images/cert-manager/azure/a-record.png)
...
![new-registration](/docs/v13.0.0-beta.1/images/cert-manager/azure/new-registration.png)
![new-registration2](/docs/v13.0.0-beta.1/images/cert-manager/azure/new-registration2.png)

You'll need the `Application (client) ID` and `Directory (tenant) ID` later for creating issuer.

![client-tenant](/docs/v13.0.0-beta.1/images/cert-manager/azure/client-tenant.png)

Now, create a new client-secret.

![client-secret](/docs/v13.0.0-beta.1/images/cert-manager/azure/client-secret.png)
...
![subscriptions](/docs/v13.0.0-beta.1/images/cert-manager/azure/subscriptions.png)
...
![user-access](/docs/v13.0.0-beta.1/images/cert-manager/azure/user-access.png)
...
![dns-zone-contributor](/docs/v13.0.0-beta.1/images/cert-manager/azure/dns-zone-contributor.png)

Now create this issuer by applying [issuer.yaml](/docs/v13.0.0-beta.1/examples/cert-manager/azure/issuer.yaml)
...
Now, Create [ingress.yaml](/docs/v13.0.0-beta.1/examples/cert-manager/azure/ingress.yaml)
...
Then create this [certificate.yaml](/docs/v13.0.0-beta.1/examples/cert-manager/azure/certificate.yaml)
