...
Now, deploy Voyager operator following instructions [here](/docs/v13.0.0-beta.1/setup/install).
...
![stats-page](/docs/v13.0.0-beta.1/images/monitoring/stats-view.png)
...
- To monitor your HAProxy pods using builtin [Prometheus](https://prometheus.io/) scraper, visit [here](/docs/v13.0.0-beta.1/guides/ingress/monitoring/using-builtin-prometheus).
- To monitor your HAProxy pods using [CoreOS Prometheus Operator](/docs/v13.0.0-beta.1/guides/ingress/monitoring/using-coreos-prometheus-operator), visit [here](/docs/v13.0.0-beta.1/guides/ingress/monitoring/using-coreos-prometheus-operator).
- To monitor Voyager operator using Prometheus, visit [here](/docs/v13.0.0-beta.1/guides/ingress/monitoring/operator-stats).
