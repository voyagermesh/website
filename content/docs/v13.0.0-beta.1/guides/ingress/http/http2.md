...
To enable http2, you must first setup a [certificate](/docs/v13.0.0-beta.1/guides/certificate) (Let's Encrypt), or use an existing one. Then create an ingress object like below:
