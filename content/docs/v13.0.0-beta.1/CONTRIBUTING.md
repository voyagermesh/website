...
url: /docs/v13.0.0-beta.1/welcome/contributing/
aliases:
- /docs/v13.0.0-beta.1/CONTRIBUTING/
info:
...
We have a [Developer Guide](/docs/v13.0.0-beta.1/setup/developer-guide/overview) that outlines everything you need to know from setting up your
