...
url: /docs/7.3.0/welcome/contributing/
aliases:
- /docs/7.3.0/CONTRIBUTING/
info:
  version: 7.3.0
---
...
We have a [Developer Guide](/docs/7.3.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
