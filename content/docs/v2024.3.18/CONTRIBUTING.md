...
url: /docs/v2024.3.18/welcome/contributing/
aliases:
- /docs/v2024.3.18/CONTRIBUTING/
info:
  cli: v0.0.15
...
We have a [Developer Guide](/docs/v2024.3.18/setup/developer-guide/overview) that outlines everything you need to know from setting up your
