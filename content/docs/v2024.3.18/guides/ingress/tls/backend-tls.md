...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/docs/v2024.3.18/guides/ingress/configuration/config-volumes) for complete example.
