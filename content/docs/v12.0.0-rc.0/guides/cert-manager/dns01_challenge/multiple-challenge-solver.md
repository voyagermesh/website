...
- [AzureDNS](/docs/v12.0.0-rc.0/guides/cert-manager/dns01_challenge/azure-dns)
- [Cloudflare](https://docs.cert-manager.io/en/latest/tasks/issuers/setup-acme/dns01/cloudflare.html)
- [Google CloudDNS](/docs/v12.0.0-rc.0/guides/cert-manager/dns01_challenge/google-cloud-dns)
- [Amazon Route53](/docs/v12.0.0-rc.0/guides/cert-manager/dns01_challenge/aws-route53)
...
multiple dns providers, like [this](/docs/v12.0.0-rc.0/examples/cert-manager/multiple.yaml):
