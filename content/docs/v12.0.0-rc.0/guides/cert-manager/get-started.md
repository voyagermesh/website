...
Like this [issuer.yaml](/docs/v12.0.0-rc.0/examples/cert-manager/issuer.yaml)
...
You can change that value using `duration` and `renewBefore` field in [certificate.yaml](/docs/v12.0.0-rc.0/examples/cert-manager/certificate.yaml),
