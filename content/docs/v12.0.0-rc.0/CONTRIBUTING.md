...
url: /docs/v12.0.0-rc.0/welcome/contributing/
aliases:
- /docs/v12.0.0-rc.0/CONTRIBUTING/
info:
...
We have a [Developer Guide](/docs/v12.0.0-rc.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
