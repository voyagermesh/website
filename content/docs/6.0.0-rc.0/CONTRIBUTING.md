...
url: /docs/6.0.0-rc.0/welcome/contributing/
aliases:
- /docs/6.0.0-rc.0/CONTRIBUTING/
info:
  version: 6.0.0-rc.0
---
...
We have a [Developer Guide](/docs/6.0.0-rc.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
