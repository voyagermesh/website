...
Now, deploy Voyager operator following instructions [here](/docs/6.0.0-rc.1/setup/install).
...
![stats-page](/docs/6.0.0-rc.1/images/monitoring/stats-view.png)
...
- To monitor your HAProxy pods using builtin [Prometheus](https://prometheus.io/) scraper, visit [here](/docs/6.0.0-rc.1/guides/ingress/monitoring/using-builtin-prometheus).
- To monitor your HAProxy pods using [CoreOS Prometheus Operator](/docs/6.0.0-rc.1/guides/mongodb/monitoring/using-coreos-prometheus-operator), visit [here](/docs/6.0.0-rc.1/guides/ingress/monitoring/using-coreos-prometheus-operator).
- To monitor Voyager operator using Prometheus, visit [here](/docs/6.0.0-rc.1/guides/ingress/monitoring/operator-stats).
