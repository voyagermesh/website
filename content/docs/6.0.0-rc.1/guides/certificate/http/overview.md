...
Deploy Voyager operator following instructions [here](/docs/6.0.0-rc.1/setup/install).
...
If you look at the Ingress, you should see that `/.well-known/acme-challenge/` path has been added to rules. It should look like [this](/docs/6.0.0-rc.1/examples/certificate/http/ing-with-acme-path.yaml).

If you check the configmap `voyager-test-ingress`, you should see a key `haproxy.cfg` with the value similar to [this](/docs/6.0.0-rc.1/examples/certificate/http/haproxy-with-acme.cfg).
...
After editing, your Ingress should look similar to [this](/docs/6.0.0-rc.1/examples/certificate/http/ing-tls-acme.yaml).

10. Now wait several seconds for HAProxy to reconfigure. If you check the configmap `voyager-test-ingress`, you should see a key `haproxy.cfg` with the value similar to [this](/docs/6.0.0-rc.1/examples/certificate/http/haproxy-ssl.cfg).
