...
To learn about necessary IAM permissions, please see [here](/docs/v12.0.0-rc.2/guides/certificate/dns/route53).
...
If you are running your cluster on Google Cloud (GKE or GCE), Voyager can use default service account associated with a VM. Please see [here](/docs/v12.0.0-rc.2/guides/certificate/dns/google-cloud) for detailed instructions.
