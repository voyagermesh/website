...
url: /docs/7.0.0-rc.1/welcome/contributing/
aliases:
- /docs/7.0.0-rc.1/CONTRIBUTING/
info:
  version: 7.0.0-rc.1
---
...
We have a [Developer Guide](/docs/7.0.0-rc.1/setup/developer-guide/overview) that outlines everything you need to know from setting up your
