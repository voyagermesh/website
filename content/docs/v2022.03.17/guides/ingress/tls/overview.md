...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/v2022.03.17/setup/install).
...
- [Using HTTP-01 challenge](/docs/v2022.03.17/guides/certificate/http/overview)
- [Using DNS-01 challenge](/docs/v2022.03.17/guides/certificate/dns/providers)
