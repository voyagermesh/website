...
- First, install Voyager operator in your cluster following the steps [here](/docs/v2025.9.19/setup/install).

- Now, deploy test servers using [this script](/docs/v2025.9.19/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
