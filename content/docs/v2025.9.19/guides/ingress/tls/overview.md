...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/v2025.9.19/setup/install).
...
- [Using HTTP-01 challenge](/docs/v2025.9.19/guides/certificate/http/overview)
- [Using DNS-01 challenge](/docs/v2025.9.19/guides/certificate/dns/providers)
