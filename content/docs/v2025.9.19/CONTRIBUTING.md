...
url: /docs/v2025.9.19/welcome/contributing/
aliases:
- /docs/v2025.9.19/CONTRIBUTING/
info:
  cli: v0.0.18
...
We have a [Developer Guide](/docs/v2025.9.19/setup/developer-guide/overview) that outlines everything you need to know from setting up your
