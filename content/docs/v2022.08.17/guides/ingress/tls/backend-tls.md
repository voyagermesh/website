...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/docs/v2022.08.17/guides/ingress/configuration/config-volumes) for complete example.
