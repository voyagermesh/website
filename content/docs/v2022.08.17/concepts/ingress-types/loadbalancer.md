...
- First, install Voyager operator in your cluster following the steps [here](/docs/v2022.08.17/setup/install).

- Now, deploy test servers using [this script](/docs/v2022.08.17/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
