...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/docs/v13.0.0-beta.0/guides/ingress/configuration/config-volumes) for complete example.
