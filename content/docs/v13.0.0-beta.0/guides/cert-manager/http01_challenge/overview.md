...
Setup a [ClusterIssuer (Or Issuer)](/docs/v13.0.0-beta.0/guides/cert-manager/get-started) for your Ingress by applying
this [clusterissuer.yaml](/docs/v13.0.0-beta.0/examples/cert-manager/http/clusterissuer.yaml)
...
Now create your ingress by applying [ingress.yaml](/docs/v13.0.0-beta.0/examples/cert-manager/http/ingress.yaml)
