...
url: /docs/v2023.02.22/welcome/contributing/
aliases:
- /docs/v2023.02.22/CONTRIBUTING/
info:
  cli: v0.0.12
...
We have a [Developer Guide](/docs/v2023.02.22/setup/developer-guide/overview) that outlines everything you need to know from setting up your
