...
To enable http2, you must first setup a [certificate](/docs/v2023.02.22/guides/certificate) (Let's Encrypt), or use an existing one. Then create an ingress object like below:
