...
Setup a [ClusterIssuer (Or Issuer)](/docs/v2023.02.22/guides/cert-manager/get-started) for your Ingress by applying
this [clusterissuer.yaml](/docs/v2023.02.22/examples/cert-manager/http/clusterissuer.yaml)
...
Now create your ingress by applying [ingress.yaml](/docs/v2023.02.22/examples/cert-manager/http/ingress.yaml)
