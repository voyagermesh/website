...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/9.0.0/setup/install).
...
- [Using HTTP-01 challenge](/docs/9.0.0/guides/certificate/http)
- [Using DNS-01 challenge](/docs/9.0.0/guides/certificate/dns/providers)
